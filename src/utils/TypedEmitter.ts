...
> {
  ...
  prependListener<E extends keyof eventName>(
    event: E,
    listener: eventName[E]
  ): this;
  prependOnceListener<E extends keyof eventName>(
    event: E,
    listener: eventName[E]
  ): this;
  ...
  removeListener<E extends keyof eventName>(
    event: E,
    listener: eventName[E]
  ): this;

  emit<E extends keyof eventName>(
    event: E,
    ...args: Parameters<eventName[E]>
  ): boolean;
